...
// static real-app screenshot (committed as img/realapp.png, NOT generated here).
// A real, dense mobile page — the honest "complex page" test. Truth boxes are
// hand-annotated in the 1200x2608 original pixel space; approximate (eyeballed, ±few px).
manifest.push({
  name: 'realapp', W: 1200, H: 2608, png: './img/realapp.png',
  tests: [
    { desc: '顶部左上角的“$18.14”金额胶囊', truth: [52, 125, 335, 218] },
    { desc: '“Authorize IG”按钮里的文字', truth: [520, 875, 800, 935] },
    { desc: '“Authorize IG”按钮里的 Instagram 图标', truth: [412, 858, 515, 945] },
    { desc: '“Enable Notifications”这一行左边的 $0.2 金额白框', truth: [82, 1245, 410, 1425] },
    { desc: '“Enable Notifications”文字', truth: [428, 1262, 1015, 1328] },
    { desc: '黄色卡片右上角的蓝色圆形图标', truth: [1030, 1188, 1197, 1366] },
    { desc: '粉色卡片的 $3 金额白框', truth: [82, 1558, 410, 1740] },
    { desc: '“Connect IG to Earn”粉色卡片右侧的箭头(>)', truth: [1028, 1604, 1115, 1692] },
    { desc: '“vConsole”绿色按钮', truth: [864, 1858, 1148, 1950] },
    { desc: '“Post my pictures of the day”卡片右侧的黑色圆形箭头(>)', truth: [1024, 2038, 1115, 2126] },
    { desc: '底部导航栏中间的“Chat”标签', truth: [535, 2405, 665, 2575] },
    { desc: '底部导航栏最右边的“Me”标签', truth: [1010, 2405, 1140, 2575] },
  ],
});

writeFileSync(join(DIR, 'manifest.json'), JSON.stringify(manifest,null,2));
console.log('generated', scenes.map(s=>s.name).join(', '), '+ realapp (static)');
